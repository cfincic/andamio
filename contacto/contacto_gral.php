...
<form action="http://www.andamio90.org/fm.php" method="post" name="SampleForm" id="SampleForm">
      <p align="center">
        ...
        <input type="hidden" name="recipients" value="mmartinezKY74NVZFandamio90.edu.ar" />
...
<tr>
      ...
      <td width="317" bgcolor="#666666"><input name="realname" type="text" /></td>
    </tr>
        <tr>
        ...
        <tr>
          ...
          <td bgcolor="#666666"><input name="Telefono" type="text" /></td>
    </tr>
        <tr>
