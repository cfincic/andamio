...
require_once("eventos/core/db.php");
	...
	foreach($col->eventos as $eve) {
			print "<table width='500' border='1' cellspacing='0' bordercolor='#E4E4E4'>";
			print"<tr>
		    <td width='138' rowspan='2'><div id='foto'><img src='http://www.andamio90.org/images/eventos/$eve->img'></div></td>
		    <td width='374'><blockquote><span class='Estilo1'>$eve->titulo</span></blockquote></td>
		    <td width='70'><span class='Estilo2'><a href='detalle_evento.php?id=$eve->evento_id' target='blank'>
			<u>Info</u></a></span>
			</td>
			</tr>
  			<tr>
    		<td colspan='2'><blockquote><span class='Estilo2'>$eve->textocorto</span></blockquote></td>
  			</tr>";
			print "<br/>";
			print "</table>";
        } 
