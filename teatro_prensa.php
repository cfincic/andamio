...
.Estilo6 {	color: #F39732;
	font-size: 10;
}
.Estilo9 {	color: #F39732;
	font-weight: bold;
}
body,td,th {
	font-family: Verdana, Arial, Helvetica, sans-serif;
...
<table width="751" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
   <td colspan="3"><img src="fireworks/header_teatro.jpg" alt="" name="teatro_l_r1_c1" width="750" height="120" border="0" usemap="#teatro_l_r1_c1MapMap2" id="teatro_l_r1_c1" />
     <map name="teatro_l_r1_c1MapMap2" id="teatro_l_r1_c1MapMap2">
