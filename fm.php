 ...
 ***  Visit www.tectite.com for free <a href="http://www.tectite.com/">forms processing software</a>.
...
$TARGET_EMAIL = array(EMAIL_NAME."@andamio90\.edu\.ar$",
						"^admisiones@andamio90\.org$",
						"^teatro@andamio90\.org$",
						"^cfincic@gmail\.com$",  
						"^cfincic@yahoo\.com\.ar$");



			/* Help: http://www.tectite.com/fmdoc/def_alert.php */

define("DEF_ALERT","cfincic@gmail.com");
...

{
	...
	$aMessages[MSG_ERROR_PROC] = 'HA OCURRIDO UN ERROR. ';
	...
	$aMessages[MSG_ABOUT_FORMMAIL] = '<a href="http://www.andamio90.org/contacto.php">Volver</a>.';
	...
	$aMessages[MSG_REQD_ERROR] = 'LOS SIGUIENTES CAMPOS DEL FORMULARIO '.
...

	{
...

		{
...

			{
				...
				$a_headers['From'] = "webmaster@andamio90.edu.ar";//$sender
